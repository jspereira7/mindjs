...
- As ideias não valem nada se não forem aplicadas. As menores implementações sempre valem mais do que a maior das intenções. ([View Highlight](https://read.readwise.io/read/01k4r3dscstzr8pmscn64834nv))
    - Note: Ou seja, a menor execução prática, vale muito mais do que a maior das intenções.

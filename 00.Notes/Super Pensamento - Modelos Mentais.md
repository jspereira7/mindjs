...
Mas para que esses modelos mentais sejam uteis, devemos aplicá-los na hora e momento certo. E para que isso aconteca, devemos conhece-los o bastante para associar os modelos corretos com as circustancias em questão.
- Quando realmente internalizar um modelo, ele deve vir a sua mente naturalmente, assim como a multiplicação. 
- Como acontece com o homem aranha e o hulk, você não tem acesso conciente aos seus super-poderes. Não será do dia pra noite.
- Ao ler esse livro pela primeira vez será como ser picado pela aranha, no homem aranha, depois da transformação inicial, é preciso desenvolver seus poderes atraves da prática repetida.
- A segunda melhor epoca para plantar uma arvore foi a vinte anos atrás, a segunda melhor e agora. 

-----

# Estar Menos Errado

> O inverso de estar mais certo é estar menos errado. 

Os modelos mentais irão te ajudar a estar menos errado, como por exemplo no tenis, um **erro não forçado** ocorre quando um jogador comete um erro não porque o outro jogador fez uma jogada excelente, mas sim porque seu julgamento ou execução foi ruim. 

Estar menos errado na quadra de tenis é necessario cometer menos erros não forçados dentro da quadra. 

E para estar menos errado na tomada de decisão você precisa consistentemente cometer menos erros não forçados na propria vida. 

O conceito de erro não forçado é um modelo mental do tenis, mas pode ser aplicado a várias areas da vida, quando um erro que poderia ser evitado é cometido. 

Comece a procurar erros não forçados ao seu redor e os verá em todo lugar. 

Mas tambem a melhor decisão tomada com informações disponiveis no momento pode se mostrar uma decisão ruim a longo prazo. 

Essa é a essencia de lidar com incerteza.
...
Você pode fazer isso tornando suas suposições mais espesificas, podendo assim testá-las. 

Uma vez que a suposição se torna espesifica o suficiente, você pode elaborar um plano para testa-las no mundo real. 
- As mais importantes para testar são aquelas mais criticas para o sucesso, e as que você está mais inseguro sobre. 

Assim que identificar as suposições criticas, o proximo passo é testá-las, comprovando-as, ou refutando-as, e depois ajustando suas estrategias.

A redução de risco pode ser aplicada para qualquer area. 
- Você pode aplica-la a tudo, politica, planejamento de ferias, rotina de exercicios.
-  Para reduzir os riscos a melhor abordagem é testar suas suposições antes
-  Basicamente é analisar e testar as premissas.

 O pior erro que você pode cometer é colocar muito esforço sem antes testar as suas premissas.

 Em programação esse conceito é chamado de Otimização Prematura, que é quando você otimiza as coisas prematuramente.

 por que? Se as suas suposições estiverem erradas, todo o esforço colocado antes é em vão e não valeu de nada sendo uma completa perda de tempo.

 É semelhante a planejar uma festa sem antes consultar se seus amigos poderão ir à festa. Todo o trabalho feito será uma completa perda de tempo.

 Todo esse trabalho poderia ser evitado se você antes testasse as  premissas dessa sua idéia

Assim com um adágio famoso: 
" Nenhum plano de batalha sobrevive ao contato com o inimigo " e como mike tyson disse " Todo mundo tem um plano até levar um soco na boca " 

Não importa o contexto dessas duas frases, o que eles querem dizer é que o primeiro plano provavelmente está errado. 
	Embora seja o melhor ponto de partida inicial, é preciso revisá-lo, sempre com feedback do mundo real. E nós recomendamos fazer o minimo de trabalho possivel antes de se ter esse feedback. 

Com a redução de risco é possivel estender o modelo mental de MVP para ajustar muitos outros contextos: 
- Organização minima viavel
- Comunicação minima viavel 
- Experimento minimo viavel

E já que temos muitos modelos mentais para explicar, estamos dando uma explicação minima viavel de cada um. 

![[Pasted image 20260504140724.png]]

O mvp nos força a avaliar as suposições rapidamente. 

Uma forma de estar errado sobre suas suposições é criar muitas suposições iniciais, ou muito complicadas, quando claramente teria um conjunto mais simples para começar. 
- A navalha de Occam pode ajudar nisso, porque ela diz que provavelmente a explicação mais simples é a mais verdadeira. 
- Quando se deparar com explicações concorrentes que explicam de forma plausivel um conjunto de dados igualmente bom, o ideal é escolher a mais simples para investigar primeiro. 
- Se chama navalha de occam porque ele corta as suposições desnecessarias.
- Albert Eistein: *"Tudo deve ser feito da maneira mais simples possivel"* 
	- Na medicina é dito assim *" Quando ouvir batidas de cascos, pense em cavalos, não em zebras "*
	- Um exemplo de relacionamentos, alguem pode colocar vários critérios na escolhe de um parceiro. 
		- Ele precisa ser brasileiro, olhos azuis, e gostar do thor dos vingadores, etc... 
		- Mas geralmente não há problema em parceiros que gostem de outro personagem dos vingadores, então deveriamos ter criterios mais simples para selecionar um parceiro
			- Exemplo: Devem fazer um ao outro rir, e se acharem mutuamente atraentes.
			- Se depois ver a necessidade de acressentar que ele deve gostar do thor, acresente depois. 

A navalha de occam não é uma lei que será sempre verdade, é apenas um guia. As vezes a explicação verdadeira pode ser sim complicada. Mas não faz sentido partir para algo complexo quando se há alternativas simples para explorar primeiro. 

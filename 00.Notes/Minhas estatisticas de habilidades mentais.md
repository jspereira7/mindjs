...
- **Estimativa:** Ela nos permite prever a futura localização de um objeto, baseado em sua velocidade, distancia e tempos atuais. 
	- O cerebro determina o que vai acontecer e como reagir rapidamente quando necessario. 
	- Usamos para processos mentais perceptivos. 
		- Para não trombar em pessoas ou coisas. 
		- Nos permite nos movermos sem tropeçar com obstáculos ou cometer acidentes.
		- Habilidade de prever o movimento de um objeto.
		- Habilidade para calcular quanto tempo existe entre dois acontecimentos.
	- Exemplos:
		- Dirigir exige estimar a velocidade do trânsito, a distância entre os carros, o tempo necessário para frear, etc.
